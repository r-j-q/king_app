...
<template>
	<view class="marquee-component" v-if="show">
		...
		<image class="imgsns" src="/static/img/ns.png"></image>
...
export default {
	...
	async mounted() {
		...
		console.log('dddff0:',this.runIndex)
		// 创建动画句柄

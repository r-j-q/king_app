<template>
	<view class="uni-steps">
		<block v-if="settype==1">
		<view :class="[direction==='column'?'uni-steps__column nnt':'uni-steps__row']">
			...
			<view :class="[direction==='column'?'uni-steps__column-container':'uni-steps__row-container']">
				<view :class="[direction==='column'?'uni-steps__column-line-item':'uni-steps__row-line-item']"
					...
					<view :class="[direction==='column'?'uni-steps__column-check nnk':'uni-steps__row-check']"
						v-if="index === active">
						<uni-icons :color="activeColor" :type="activeIcon" size="24"></uni-icons>
					</view>
					<view v-else :class="[direction==='column'?'uni-steps__column-circle ddn':'uni-steps__row-circle']"
			...
			<view  :class="[direction==='column'?'uni-steps__column-text-container':'uni-steps__row-text-container']">
				<view v-for="(item,index) in options" :key="index" @click="setparentTest(index)"
					:class="[direction==='column'?'uni-steps__column-text nns':'uni-steps__row-text']">
					<view class="nesflex">
						<view :style="{color:index === active?activeColor:deactiveColor}"
							:class="[direction==='column'?'uni-steps__column-title nny':'uni-steps__row-title']">{{item.title}}</view>
						<view :style="{color: deactiveColor}"
							:class="[direction==='column'?'uni-steps__column-desc nny':'uni-steps__row-desc']">{{item.desc}}</view>
					</view>
				</view>
			</view>
		</view>
		...
		<block v-else>
			<view :class="[direction==='column'?'uni-steps__column':'uni-steps__row']">
				...
				<view style="padding-top: 20upx;" :class="[direction==='column'?'uni-steps__column-text-container':'uni-steps__row-text-container']">
					<view v-for="(item,index) in options" :key="index" @click="setparentTest(index)"
